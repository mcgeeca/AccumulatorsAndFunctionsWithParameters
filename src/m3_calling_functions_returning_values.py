...
def digits_in_cube(n):
    ...
    # ------------------------------------------------------------------
    numberCubed = n*n*n
    cubed_sum_of_digits = sum_of_digits(numberCubed)
    return cubed_sum_of_digits
...
def run_test_digits_in_power():
    ...
    # Test 2
    expected = 108
    answer = digits_in_power(15, 20)
    print("Test 2 expected:", expected)
    print("       actual:", answer)
    # Test 3
    expected = 199
    answer = digits_in_power(25, 30)
    print("Test 3 expected:", expected)
    print("       actual:", answer)
...
def digits_in_power(n, k):
    ...
    ####################################################################
    # ------------------------------------------------------------------
    summed_digits_in_x = sum_of_digits(n**k)
    return summed_digits_in_x
